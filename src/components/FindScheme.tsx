        ...
        <div className="container flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="col-span-1 flex items-center justify-center">
              <button className="rounded-xl border border-[var(--border)] hover:border-[var(--primary)] bg-[var(--bg-secondary)] py-2.5 px-6 pl-10 text-md focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-all duration-300 shadow-sm text-center">
                Search
              </button>
            </div>
          </div>
