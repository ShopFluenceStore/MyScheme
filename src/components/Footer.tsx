...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[var(--gray)] text-white">
      {/* Main Footer Content */}
            ...
            <div className="grid grid-cols-3 gap-3">
              {usefulLogos.map((logo, index) => (
                <a
                  key={index}
                  href="#"
                  className="bg-white rounded-lg p-2 hover:bg-[var(--primary)] transition-colors duration-200 group"
                >
                  <Image
                    src={logo.src}
                    alt={logo.alt}
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[var(--border)] bg-[var(--gray)]">
